...
parser.add_argument('--epochs', type=int,  default=20, help='Number of epochs to train benign and backdoor model.')
parser.add_argument('--trojan_epochs', type=int,  default=20, help='Number of epochs to train trigger generator.')
